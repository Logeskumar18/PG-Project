...
const Register = () => {
  ...
  const validateForm = () => {
    ...
    if (formData.role === 'HOD' || formData.role === 'Guide') {
  ...
  const handleSubmit = async (e) => {
    ...
    // Prepare data - exclude confirmPassword and empty fields
                ...
                <Form onSubmit={handleSubmit}>
                  ...
                  <Form.Group className="mb-3">
                    ...
                    >
                      ...
                      <option value="Guide">Guide (Faculty/Mentor)</option>
                  ...
                  {(formData.role === 'HOD' || formData.role === 'Guide') && (
                    <Form.Group className="mb-3">

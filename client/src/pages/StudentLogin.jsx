...
const StudentLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await login({ ...formData, role: 'Student' });
  ...
  return (
    <div className="min-vh-100 d-flex align-items-center" style={{background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)'}}>
            ...
            <Card className="shadow-lg border-0 rounded-4">
              <Card.Body className="p-5">
                <div className="text-center mb-4">
                  <div className="mb-3">
                    <div className="d-inline-flex align-items-center justify-content-center rounded-circle" style={{width: '80px', height: '80px', background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)'}}>
                  ...
                  <h1 className="fw-bold mb-2">Student Login</h1>
      ...
      <ForgotPasswordModal show={showForgot} onHide={() => setShowForgot(false)} role={"Student"} />
      {/* Error Modal */}
